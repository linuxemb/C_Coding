...
//git@github.com:linuxemb/C_Coding.git
//https://www.geeksforgeeks.org/delete-all-odd-nodes-of-a-circular-linked-list/?ref=leftbar-rightbar	
...
void deleteoddNodes(Node* head) 
{
   ...
   do {
	   // if is odd nodes call deleteNode
	   if((ptr -> data %2) ==1)
	   deleteNode(head, ptr);
